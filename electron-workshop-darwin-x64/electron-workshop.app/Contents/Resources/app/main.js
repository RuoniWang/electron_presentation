...
app.on('ready', function () {
  ...
  const ret1 = globalShortcut.register('CommandOrControl+H', () => {
  app.hide()
})
  const ret2 = globalShortcut.register('CommandOrControl+S', () => {
    app.show()
})
  const ret3 = globalShortcut.register('CommandOrControl+N', () => {
    createWindow(true, true)
})
  const ret4 = globalShortcut.register('CommandOrControl+F', () => {
